...
package org.ubl.trellisldp.serialization;
...
public class KafkaEventConsumer {
    ...
    public static class Events extends MainListenerSupport {
        ...
        public void afterStart(final MainSupport main) {
            LOGGER.info("KafkaEventConsumer with Camel is now started!");
        }

        @Override
        public void beforeStop(final MainSupport main) {
            LOGGER.info("KafkaEventConsumer with Camel is now being stopped!");
        }
    }
